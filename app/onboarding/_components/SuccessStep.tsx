  ...
  return (
    <div className="animate-fade-in-up text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <a
          href="/dashboard"
          className="flex items-center justify-center gap-2 px-8 py-3 bg-card border border-border border border-border rounded-md text-sm font-medium transition-all text-foreground cursor-pointer"
        >
          Go to Dashboard
        </a>
        <a
          ...
          className="flex items-center justify-center gap-2 px-8 py-3 bg-primary hover:bg-primary-hover rounded-md text-sm font-medium transition-all text-white cursor-pointer"
        >
